...
export default function About() {
  ...
  const translations = {
    en: { home: 'Home', about: 'About', contact: 'Contact', pricing: 'Pricing', profile: 'Profile', logout: 'Logout', login: 'Login', signup: 'Sign Up', title: 'Terms & Conditions', desc: 'Read the rules and guidelines for using our platform.', copyright: '© 2026 Theology & Geopolitics' },
    hi: { home: 'होम', about: 'परिचय', contact: 'संपर्क', pricing: 'मूल्य', profile: 'प्रोफाइल', logout: 'लॉगआउट', login: 'लॉगिन', signup: 'साइन अप', title: 'नियम और शर्तें', desc: 'हमारे प्लेटफ़ॉर्म के उपयोग के नियम और दिशानिर्देश पढ़ें।', copyright: '© 2026 धर्मशास्त्र और भू-राजनीति' },
    es: { home: 'Inicio', about: 'Acerca de', contact: 'Contacto', pricing: 'Precios', profile: 'Perfil', logout: 'Cerrar Sesión', login: 'Iniciar Sesión', signup: 'Registrarse', title: 'Términos y Condiciones', desc: 'Lee las reglas y directrices para usar nuestra plataforma.', copyright: '© 2026 Teología y Geopolítica' },
    fr: { home: 'Accueil', about: 'À Propos', contact: 'Contact', pricing: 'Tarifs', profile: 'Profil', logout: 'Déconnexion', login: 'Connexion', signup: 'S\'inscrire', title: 'Conditions Générales', desc: 'Lisez les règles et directives pour utiliser notre plateforme.', copyright: '© 2026 Théologie et Géopolitique' },
    de: { home: 'Startseite', about: 'Über Uns', contact: 'Kontakt', pricing: 'Preise', profile: 'Profil', logout: 'Abmelden', login: 'Anmelden', signup: 'Registrieren', title: 'Allgemeine Geschäftsbedingungen', desc: 'Lesen Sie die Regeln und Richtlinien für die Nutzung unserer Plattform.', copyright: '© 2026 Theologie und Geopolitik' },
    zh: { home: '首页', about: '关于', contact: '联系', pricing: '价格', profile: '个人资料', logout: '登出', login: '登录', signup: '注册', title: '条款和条件', desc: '阅读使用我们平台的规则和指南。', copyright: '© 2026 神学与地缘政治' },
    ja: { home: 'ホーム', about: '概要', contact: 'お問い合わせ', pricing: '料金', profile: 'プロフィール', logout: 'ログアウト', login: 'ログイン', signup: 'サインアップ', title: '利用規約', desc: '当社のプラットフォームの利用規約をご確認ください。', copyright: '© 2026 神学と地政学' }
  }
    ...
    <div style={{ background: 'linear-gradient(135deg, #0f0f1e 0%, #1a1a2e 50%, #16213e 100%)', color: '#e0e0e0', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '5rem 2rem' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, rgba(100, 200, 255, 0.08), rgba(255, 100, 200, 0.06))', border: '1px solid rgba(100, 200, 255, 0.2)', padding: '3rem', borderRadius: '12px', marginBottom: '3rem' }}>
          ...
          <h2 style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '1.5rem', color: '#fff' }}>Use of Service</h2>
          <p style={{ fontSize: '1.05rem', color: '#c0c0c0', lineHeight: '1.8', marginBottom: '2rem' }}>
            By accessing this platform, you agree to use it only for lawful purposes. You must not misuse the content, attempt to gain unauthorized access, or disrupt the functionality of the website.
          </p>
          
          <h2 style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '1.5rem', color: '#fff' }}>User Responsibilities</h2>
          <p style={{ fontSize: '1.05rem', color: '#c0c0c0', lineHeight: '1.8' }}>
            Users are responsible for maintaining the confidentiality of their accounts and for all activities that occur under them. We reserve the right to suspend or terminate access if terms are violated.
          </p>
